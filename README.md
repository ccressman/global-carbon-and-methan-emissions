This project leverages Python, Flask, SQLite, JavaScript, Leaflet, D3, and HTML to generate interactive heat maps displaying carbon and methane emissions for over 200 countries.
